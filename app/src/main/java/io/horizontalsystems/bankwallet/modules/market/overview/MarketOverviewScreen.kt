...
import io.horizontalsystems.bankwallet.modules.market.search.SearchView
...
fun MarketOverviewScreen(
    ...
    topCoinsViewModel: MarketTopCoinsViewModel,
                ...
                ViewState.Success -> {
                    viewItem?.let { viewItem ->
                        Column(
                            ...
                            SearchView(
                                onSearchTextChange = { query -> searchViewModel.searchByQuery(query) },
