...
// set the drawable as the icon of the menu item
        ...
        binding.bottomNavigation.setOnNavigationItemSelectedListener {
            when (it.itemId) {
                R.id.navigation_wallet -> binding.viewPager.setCurrentItem(0, false)
                R.id.navigation_track -> binding.viewPager.setCurrentItem(1, false)
                R.id.navigation_home -> binding.viewPager.setCurrentItem(2, false)
                R.id.navigation_social -> binding.viewPager.setCurrentItem(3, false)
                R.id.navigation_reports -> binding.viewPager.setCurrentItem(4, false)
            }
            true
        }

        binding.bottomNavigation.findViewById<View>(R.id.navigation_wallet)
