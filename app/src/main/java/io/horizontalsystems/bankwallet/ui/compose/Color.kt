...
val OrangeK = Color(red = 237, green = 110, blue = 0, alpha = 255)
val BlueK =  Color(red = 31, green = 27, blue = 222, alpha = 255)
val LightBlueK =  Color(red = 0, green = 102, blue = 255, alpha = 255)
val CyanK =  Color(red = 27, green = 210, blue = 222, alpha = 255)
