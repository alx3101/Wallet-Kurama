...
class App : CoreApp(), WorkConfiguration.Provider, ImageLoaderFactory {
    ...
    companion object : ICoreApp by CoreApp {
        ...
        lateinit var balanceViewItemFactory: BalanceViewItemFactory
        lateinit var faqManager: FaqManager
        //  lateinit var service: BalanceService
        lateinit var totalBalance: TotalBalance
    }
